import drive, sys
RAW=[('jump',(24,5),(24,4),(24,3)),('jump',(24,3),(23,3),(22,3)),('jump',(23,3),(22,3),(21,3)),
('jump',(22,3),(21,3),(20,3)),('jump',(21,3),(20,3),(19,3)),('jump',(20,3),(19,3),(18,3)),
('jump',(19,3),(18,3),(17,3)),('jump',(18,3),(17,3),(16,3)),('jump',(17,3),(16,3),(15,3)),
('jump',(15,3),(15,4),(15,5)),
('press','ACTION2'),('press','ACTION3'),('press','ACTION2'),('press','ACTION4'),('press','ACTION1'),('press','ACTION1'),
...
for i,s in enumerate(steps):
    ...
    if s[0]=='press': drive.press(s[1],'L6u step %d: %s'%(i,' '.join(s[1])))
    else:
        _,a,m,l=s
        drive.click(a,'L6u step %d: jump %s over %s -> %s (select)'%(i,a,m,l))
        drive.click(l,'L6u step %d: land'%i)
